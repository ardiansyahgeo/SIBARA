...
map.getView().fit([11854430.311176, -821697.337385, 11934168.114558, -775240.413600], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://drive.google.com/file/d/10Q7aCk8549dPzxGFmb_7C-hytV4kAUm2/view?usp=sharing">LAMPIRAN PERMEN PU NOMOR 05/PRT/M/2016</a> &middot; ';
        ...
        qgisAttribution.innerHTML = '<a href="http://inarisk.bnpb.go.id/webgis/">inarisk BNPB</a>';
